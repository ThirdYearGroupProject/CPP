...
import ic.doc.cpp.client.student.core.data.StudentInterestedCompanyDetailDataSource;
...
public class StudentInterestedCompanyView extends ViewImpl implements
		StudentInterestedCompanyPresenter.MyView {
	...
	@Inject
	public StudentInterestedCompanyView() {
	    ...
	    VLayout header = StudentProfileView.initHeader("Company Information", "View companies' information you are interested in");
	    header.setStyleName("wizard-Header");
	    
	    container.setMembers(header, interestedCompanyTileGrid);
	}
