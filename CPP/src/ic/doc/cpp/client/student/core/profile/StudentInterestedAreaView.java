...
public class StudentInterestedAreaView extends ViewImpl implements
		StudentInterestedAreaPresenter.MyView {
	...
	@Inject
	public StudentInterestedAreaView() {
        ...
        VLayout header = StudentProfileView.initHeader("Interested Areas", "View/Change your interested areas");
